...
// SkipVolumeCheck allows opening a middle volume without requiring it to be
// volume 0. When set, the volume number from the archive header is accepted
// as-is, enabling individual scanning of continuation volumes.
